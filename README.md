...
> the 2026 Finam Arena competition. The repository preserves the market
> scanning, H4/Arena analysis, risk-control, learning and guarded-execution
> layers built around a Hermes agent. It is not affiliated with Finam and is
...
Этот бот появился не как отвлечённый pet project. В течение двух месяцев он
работал как технический контур ИИ-агента на платформе Hermes: каждый торговый
...
В [интервью Finam.ru](https://www.finam.ru/publications/item/bitva-algoritmov-zachem-treydery-testiruyut-ii-na-finam-arene-20260627-2040/)
автор проекта описал шесть уровней этой системы:
...
Основная библиотека не зависит от Hermes. `scripts/hermes_operator.py`
